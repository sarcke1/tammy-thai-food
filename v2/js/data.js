...
export const dishes = [
  ...
  { id:"chicken-massena", name:"Chicken Massena", price:11, category:"Plats", emoji:"🥜", photo:"Chicken massena.png", desc:"Poulet sauté aux noix de cajou, poivrons rouges et verts, oignons et cibettes dans une sauce thaïlandaise savoureuse. Servi avec 150 g de riz jasmin.", spicy:false },
...
export const preparation = {
  pad:{base:8,extra:2}, "chicken-massena":{base:8,extra:1}, jour:{base:7,extra:2}, kids:{base:5,extra:1.5}, "riz-saute":{base:8,extra:1}, "tom-kha-kai":{base:8,extra:1},
